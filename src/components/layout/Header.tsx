...
export function Header() {
  ...
  const navLinks = [
    { name: '?åÏÇ¨?åÍ∞ú', path: '/about' },
    { 
      name: 'Í∏∞Ïà†', 
      path: '/tech',
      dropdown: [
        { name: '?¥Î?ÏßÄ Ï≤òÎ¶¨', path: '/tech#image-processing' },
    ...
    { name: '?ÅÎã¥Î¨∏Ïùò', path: '/contact' },
    { name: '?§Ïãú?îÍ∏∏', path: '/location' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center gap-2">
            <img src="/logo.png" alt="?§Ï∫î?ÄÎ¶?Î°úÍ≥†" className="w-8 h-8 object-cover rounded-sm" />
            <span className="text-2xl font-bold tracking-tighter">?§Ï∫î ?ÄÎ¶?/span>
          </Link>
